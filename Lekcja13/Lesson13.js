...
const { brand, model, yearOfProduction } = car; // Destrukturyzacja poza obiektem

function carFunc(car, model, year) {
  return `Brand ${car}, Model ${model}, year ${year}`;
}

const car1 = carFunc(brand, model, yearOfProduction);
